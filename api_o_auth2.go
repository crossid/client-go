...
// Token Request, as form data.
func (r ApiOauth2TokenRequest) TokenRequest(tokenRequest TokenRequest) ApiOauth2TokenRequest {
	r.tokenRequest = &tokenRequest
	return r
}

func (r ApiOauth2TokenRequest) Execute() (Token, *_nethttp.Response, error) {
	return r.ApiService.Oauth2TokenExecute(r)
}

/*
Oauth2Token Request a token from the OAuth2 authorization server.

The token endpoint is used by the client to obtain an access token from an OAuth2 authorization server.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOauth2TokenRequest
*/
func (a *OAuth2ApiService) Oauth2Token(ctx _context.Context) ApiOauth2TokenRequest {
	return ApiOauth2TokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Token
func (a *OAuth2ApiService) Oauth2TokenExecute(r ApiOauth2TokenRequest) (Token, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ApiService.Oauth2Token")
	if err != nil {
